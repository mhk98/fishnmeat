...
export const productApi = createApi({
  ...
  endpoints: (build) => ({
    ...
    getAllProduct: build.query({
      query: ({ page, limit, category_id, subCategoryItem_id, brand_id, searchTerm, title}) => ({
        url: "/product",
        params: { page, limit, category_id, subCategoryItem_id, brand_id, searchTerm, title},  // Pass the page and limit as query params
      }),
